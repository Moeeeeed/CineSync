...
Developed as part of the **Applied Human-Computer Interaction** coursework at FAST-NUCES, this project utilizes extensive quantitative and qualitative research to streamline movie discovery, enhance personal library curation, and solve group decision paralysis.

## ✨ Core Features (UX Solutions)
Based on our research with over 100+ survey respondents and field observations, we designed four distinct user flows:
...
## 🧠 The HCI Process
Our design decisions are backed by empirical validation:
1.  **Heuristic Evaluation:** Identified core usability flaws in the current IMDb architecture.
2.  **Requirement Gathering:** Distributed conditional-branching surveys (101 responses) and conducted contextual semi-structured interviews.
3.  **Persona Development:** Created specialized profiles mapping to real user behaviors (The Scanner, The Curator, The Compromiser, The Researcher).
4.  **Task Flows & Storyboarding:** Mapped out execution paths to reduce click-fatigue.
5.  **Wireframing & Prototyping:** Built low-fidelity sketches and mid-fidelity digital wireframes to establish robust information architecture.
